...
export function buildInstantAlertHtml(
  ...
  const earlyAccessBadge = isEarlyAccess
    ? `<div style="text-align:center;margin-bottom:16px;">
        <span style="display:inline-block;background:#f59e0b;color:#000;font-size:12px;font-weight:700;padding:4px 12px;border-radius:12px;text-transform:uppercase;letter-spacing:0.5px;">
          Early Access
        </span>
      </div>`
    : '';
  ...
  const subtitle = isEarlyAccess
    ? 'You\'re seeing this before anyone else as an Elite member.'
    : 'A new listing just became available that matches your buy box.';
...
<body style="margin:0;padding:0;background:#0d0d1a;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:24px 16px;">
    ...
    <div style="text-align:center;padding:24px 0;border-bottom:1px solid #2a2a4a;margin-bottom:24px;">
      ...
      <p style="margin:4px 0 0;font-size:14px;color:#999999;">New Listing Alert</p>
    </div>
    ...
    <div style="border-top:1px solid #2a2a4a;padding-top:24px;text-align:center;">
      <p style="font-size:12px;color:#666666;margin:0;">
        You're receiving this because you have instant email alerts enabled.
      </p>
