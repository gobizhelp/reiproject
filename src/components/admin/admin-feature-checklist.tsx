...
const BUYER_TIER_MAP: Record<BuyerFeature, Tier> = {
  ...
  proof_of_funds_upload: 'pro',
  pro_buyer_badge: 'pro',
  sms_alerts: 'elite',
  push_notifications: 'elite',
  first_look_access: 'elite',
  premium_inventory: 'elite',
  verified_buyer_badge: 'elite',
  verified_proof_of_funds_badge: 'elite',
  team_seats: 'elite',
  shared_team_pipeline: 'elite',
  shared_notes: 'elite',
  bulk_export: 'elite',
  advanced_buyer_analytics: 'elite',
...
const SELLER_TIER_MAP: Record<SellerFeature, Tier> = {
  ...
  property_flyer_generation: 'pro',
  sms_blast: 'elite',
  buyer_list_import: 'elite',
  audience_segmentation: 'elite',
  vip_first_release: 'elite',
  timed_release_windows: 'elite',
